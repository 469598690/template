  ...
  <span slot="footer" class="dialog-footer">
    ...
    <div class="box">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
         ...
         <el-form-item style="margin-left:-60px;"   prop="title" class="form_title">
...
>
             ...
             <el-form-item v-else >
<el-input placeholder="请输入链接地址 例：http:// 或 https://" v-model="form.linkUrl" style="width:60%">
...
<el-input v-model.trim="form.toTmailList" placeholder="请输入内容" style="width:40%"></el-input>
...
export default {
  ...
  methods: {
    ...
    // 群发消息
    on_send() {
      if(this.radio==1&&this.form.file.length==0){
        this.$message.warning('请上传群发对象文件')
        return false
      }
       if(this.radio!=1&&this.form.toTmailList.length==0){
        this.$message.warning('请输入群发Tmail地址')
        return false
      }
      if(this.form.linkUrl.length>=200){
        this.$message.warning('url长度不能大于200个字符')
        return false
      }
...
<style>
.form_title .el-form-item__error{
  margin-left: 60px;
}
</style>
