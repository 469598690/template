  ...
  <div>
    <div v-if="add">
      <div class="wrap">
        ...
        <el-input placeholder="搜索关键词" class="inp" v-model="tableData.name"></el-input>
        <el-button class="btn" type="success" @click="addSave">添加回复</el-button>
      </div>
      <el-table
        class="table"
        :data="tableData"
      ...
      <el-form ref="form" :model="form" label-width="80px">
        <!-- <el-form-item label="规则名称">
          <el-input v-model="form.name" placeholder="请输入规则名称" maxLength="60"></el-input>
          <p>规则名最多60个字</p>
        </el-form-item> -->
        <el-form-item label="关键词">
      
          <el-input class="sel-inp" v-model="form.key" placeholder="输入关键字"></el-input>
        </el-form-item>
